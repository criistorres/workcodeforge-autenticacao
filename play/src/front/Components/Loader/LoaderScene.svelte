<script lang="ts">
    ...
    import defaultLoader from "../images/Beauty-loader.gif";

    const logo = defaultLoader;
...
<div
    class="absolute top-0 left-0 z-50 h-dvh w-dvw"a
...
>
    <div class="flex items-center min-h-dvh w-full w-dvw relative z-30">
        <div class="flex flex-col items-center justify-center w-full h-full relative">
            <!--
            {#if defaultLoader && gameManager.currentStartedRoom.showPoweredBy !== false}
